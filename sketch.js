...
function setup() {
  ...
  bg = createSprite(displayWidth/2-20,displayHeight/2-90,20,20)
bg.addImage(bgImg)
bg.scale = 1.5
...
if(keyWentDown("space")){
  bullet = createSprite(displayWidth-1600,player.y-10,20,10)
  bullet.velocityX = 20
...
function enemy(){
  if(frameCount%50===0){
    ...
    zombie = createSprite(random(1200, 1800), height-random(100, 600),40,40)
